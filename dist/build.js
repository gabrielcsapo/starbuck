...
// module
exports.push([module.i, "* {\n  font-family: Open Sans, sans-serif\n}\n\n.navbar {\n  background-color: white;\n  border-top: 5px solid #222;\n  border-bottom: 2px solid #ddd;\n}\nbody {\n  margin-bottom: 50px;\n}\n.content {\n  margin-top: 50px;\n}\n.center {\n  text-align: center;\n  width: 50%;\n  position: absolute;\n  left: 25%;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n.tab {\n    overflow: hidden;\n}\n.tab button {\n  background-color: #f1f1f1;\n  border: 1px solid #e4e4e4;\n  border-top: 2px solid #e4e4e4;\n  float: left;\n  outline: none;\n  cursor: pointer;\n  padding: 14px 16px;\n  transition: 0.3s;\n}\n.tab button:hover {\n    background-color: #ddd;\n    border-top: 2px solid rgba(203, 224, 255, 0.79);\n}\n.tab button.active {\n    border-top: 2px solid rgba(115, 171, 255, 0.79);\n}\n\n.status-updated {\n  width: 15px;\n\theight: 15px;\n  display: inline-block;\n\tbackground: rgba(0, 128, 0, 0.50);\n\t-moz-border-radius: 15px;\n\t-webkit-border-radius: 15px;\n\tborder-radius: 15px;\n}\n.status-notupdated {\n  width: 15px;\n\theight: 15px;\n\tbackground: rgba(255, 0, 0, 0.50);\n  display: inline-block;\n\t-moz-border-radius: 15px;\n\t-webkit-border-radius: 15px;\n\tborder-radius: 15px;\n}\n", "", {"version":3,"sources":["/Users/gabrielcsapo/Documents/starbuck/src/style.css"],"names":[],"mappings":"AAAA;EACE,kCAAkC;CACnC;;AAED;EACE,wBAAwB;EACxB,2BAA2B;EAC3B,8BAA8B;CAC/B;AACD;EACE,oBAAoB;CACrB;AACD;EACE,iBAAiB;CAClB;AACD;EACE,mBAAmB;EACnB,WAAW;EACX,mBAAmB;EACnB,UAAU;EACV,SAAS;EACT,4BAA4B;CAC7B;;AAED;IACI,iBAAiB;CACpB;AACD;EACE,0BAA0B;EAC1B,0BAA0B;EAC1B,8BAA8B;EAC9B,YAAY;EACZ,cAAc;EACd,gBAAgB;EAChB,mBAAmB;EACnB,iBAAiB;CAClB;AACD;IACI,uBAAuB;IACvB,gDAAgD;CACnD;AACD;IACI,gDAAgD;CACnD;;AAED;EACE,YAAY;CACb,aAAa;EACZ,sBAAsB;CACvB,kCAAkC;CAClC,yBAAyB;CACzB,4BAA4B;CAC5B,oBAAoB;CACpB;AACD;EACE,YAAY;CACb,aAAa;CACb,kCAAkC;EACjC,sBAAsB;CACvB,yBAAyB;CACzB,4BAA4B;CAC5B,oBAAoB;CACpB","file":"style.css","sourcesContent":["* {\n  font-family: Open Sans, sans-serif\n}\n\n.navbar {\n  background-color: white;\n  border-top: 5px solid #222;\n  border-bottom: 2px solid #ddd;\n}\nbody {\n  margin-bottom: 50px;\n}\n.content {\n  margin-top: 50px;\n}\n.center {\n  text-align: center;\n  width: 50%;\n  position: absolute;\n  left: 25%;\n  top: 50%;\n  transform: translateY(-50%);\n}\n\n.tab {\n    overflow: hidden;\n}\n.tab button {\n  background-color: #f1f1f1;\n  border: 1px solid #e4e4e4;\n  border-top: 2px solid #e4e4e4;\n  float: left;\n  outline: none;\n  cursor: pointer;\n  padding: 14px 16px;\n  transition: 0.3s;\n}\n.tab button:hover {\n    background-color: #ddd;\n    border-top: 2px solid rgba(203, 224, 255, 0.79);\n}\n.tab button.active {\n    border-top: 2px solid rgba(115, 171, 255, 0.79);\n}\n\n.status-updated {\n  width: 15px;\n\theight: 15px;\n  display: inline-block;\n\tbackground: rgba(0, 128, 0, 0.50);\n\t-moz-border-radius: 15px;\n\t-webkit-border-radius: 15px;\n\tborder-radius: 15px;\n}\n.status-notupdated {\n  width: 15px;\n\theight: 15px;\n\tbackground: rgba(255, 0, 0, 0.50);\n  display: inline-block;\n\t-moz-border-radius: 15px;\n\t-webkit-border-radius: 15px;\n\tborder-radius: 15px;\n}\n"],"sourceRoot":""}]);
...
*/
var aa=__webpack_require__(0);__webpack_require__(8);var l=__webpack_require__(36),n=__webpack_require__(17),ba=__webpack_require__(37),ca=__webpack_require__(6),da=__webpack_require__(18),ea=__webpack_require__(38),fa=__webpack_require__(39),ha=__webpack_require__(42),ia=__webpack_require__(43);
...
/*
 ...
 LICENSE file in the root directory of this source tree.
*/
var f=__webpack_require__(17),p=__webpack_require__(18);__webpack_require__(8);var r=__webpack_require__(6);
...
exports.default = _react2.default.createElement(
	...
	_react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/:service/:owner/:repo', component: _Dependencies2.default })
		)
	)
);
	...
	_createClass(Dependencies, [{
		...
		value: function render() {
			...
			var _state = this.state,
			    _state$info = _state.info,
			    info = _state$info === undefined ? {} : _state$info,
			...
			return _react2.default.createElement(
				...
				info ? _react2.default.createElement(
					...
					_react2.default.createElement('br', null),
					_react2.default.createElement('img', { src: '/badge/' + service + '/' + owner + '/' + repo + '/' + badge + '.svg', style: { float: 'right', marginTop: '25px' } }),
					_react2.default.createElement(_DependenciesTable2.default, _extends({}, starbuck, { changeTab: this.changeTab.bind(this) }))
				) : _react2.default.createElement(
					'div',
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ className: 'tablinks ' + (selected === 'dependencies' ? 'active' : ''), onClick: this.changeTab.bind(this, 'dependencies') },
						'dependencies (',
					...
					_react2.default.createElement(
						'button',
						{ className: 'tablinks ' + (selected === 'devDependencies' ? 'active' : ''), onClick: this.changeTab.bind(this, 'devDependencies') },
						'devDependencies (',
					...
					_react2.default.createElement(
						'button',
						{ className: 'tablinks ' + (selected === 'peerDependencies' ? 'active' : ''), onClick: this.changeTab.bind(this, 'peerDependencies') },
						'peerDependencies (',
